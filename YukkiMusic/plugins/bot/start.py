...
from Void X Music.utils.decorators.language import LanguageStart
from Void X Music.utils.inline import (help_pannel, private_panel,
                                     start_pannel)
...
⚡️ __Searched Powered By {config."Void X Music"}__"""
        ...
        try:
            ...
            OWNER = "Husbandoo"
        out = private_panel(_, app."Husbandoo")
